...
function DocumentsTab({ data, methodology }) {
  const agile = [
    { title: 'Project Overview', desc: 'A summary of the project, its goal and current status.', ready: true },
    { title: 'Backlog Export', desc: 'Your full list of work areas and items to build.', ready: true },
    { title: 'Sprint Summary', desc: 'A report of all completed work cycles and their outcomes.', ready: false },
    { title: 'Lessons Learned Report', desc: 'A summary of all your retrospective reflections.', ready: false },
    { title: 'Risk Report', desc: 'All identified risks and their current status.', ready: true },
  ];

  const predictive = [
    { title: 'Project Charter', desc: 'The official document that authorises your project.', ready: true },
    { title: 'Stakeholder Register', desc: 'A full list of everyone involved and how to manage them.', ready: true },
    { title: 'Scope Statement', desc: 'What is in scope, out of scope, assumptions and constraints.', ready: true },
    { title: 'Project Management Plan', desc: 'The full plan covering timeline, resources, quality and communications.', ready: false },
    { title: 'Risk Register', desc: 'All identified risks and their current status.', ready: true },
    { title: 'Compliance Checklist', desc: 'Internal and external rules this project must follow.', ready: false },
  ];

  const docs = methodology === 'Agile' ? agile : predictive;

  return (
    <div>
      <SectionHead title="Documents" sub="Your project documents are generated from the information you have entered. Download or share them anytime." />
      {docs.map((doc, i) => (
        <div key={i} style={s.docCard}>
          ...
          {doc.ready ? (
            ...
            <span style={{ ...s.pill, background: '#EFF6FF', color: BLUE }}>Coming Soon</span>
          )}
        </div>
      ))}
    </div>
