            ...
            {projects.map(p => (
              <div key={p.id} style={s.card}>
                ...
                <div style={s.scoreRow}>
                  ...
                  <span style={s.score}>{p.analysis.score}/100</span>
                </div>
                <p style={s.verdict}>{p.analysis.verdict}</p>
...
const s = {
  ...
  title: { fontSize: 24, fontWeight: 800, color: BL, letterSpacing: '-0.4px', marginBottom: 2 },
  sub: { fontSize: 13, color: '#6B7280' },
  headerBtns: { display: 'flex', gap: 8 },
  newBtn: { padding: '9px 18px', background: B, color: WH, border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' },
  ...
  emptyCard: { background: WH, border: '1px solid #E5E7EB', borderRadius: 16, padding: '48px 32px', textAlign: 'center', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' },
  emptyTitle: { fontSize: 18, fontWeight: 800, color: BL, marginBottom: 8 },
  emptySub: { fontSize: 14, color: '#6B7280', marginBottom: 24 },
  grid: { display: 'flex', flexDirection: 'column', gap: 12 },
  card: { background: WH, border: '1px solid #E5E7EB', borderRadius: 16, padding: '20px 22px', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' },
  cardTop: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
  modeBadge: { fontSize: 11, fontWeight: 700, padding: '3px 10px', borderRadius: 100, background: B + '12', color: B },
  date: { fontSize: 12, color: '#9CA3AF' },
  cardTitle: { fontSize: 17, fontWeight: 800, color: BL, marginBottom: 10, letterSpacing: '-0.2px' },
  ...
  score: { fontSize: 15, fontWeight: 800, color: B },
  verdict: { fontSize: 13, fontWeight: 600, marginBottom: 16, color: '#6B7280' },
  cardBtns: { display: 'flex', gap: 8 },
  openBtn: { padding: '8px 16px', background: B, color: WH, border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' },
